...
class RedaxApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Redax Mini — Offline Redaction (MVP)")
        ...
        self.mode: str = "black"                         # or "pixelate"
        self.pixel_size: int = 12
    ...
    def _build_ui(self):
        ...
        # Mode selector
        mode_lbl = ctk.CTkLabel(tb, text="Mode:")
        mode_lbl.pack(side="left", padx=(18, 4))
        ...
        # Zoom controls
        zoom_lbl = ctk.CTkLabel(tb, text="Zoom:")
        zoom_lbl.pack(side="left", padx=(18, 4))
    ...
    def on_theme_change(self, value):
        ...
        # ---- Labels ----
        labels = [self.pixel_lbl, self.status]
        for lbl in labels:
            lbl.configure(text_color=theme["button_text"])
